...
import FEC_PIN_Label from '@salesforce/label/c.FEC_PIN_Label';
import FEC_Fee_Label from '@salesforce/label/c.FEC_Fee_Label';
...
export default class Fec_SecondaryInfoAccount extends LightningElement {
    ...
    customLabel = {
        ...
        pinLabel: FEC_PIN_Label,
        feeLabel: FEC_Fee_Label,
