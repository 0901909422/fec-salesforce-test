                ...
                try {
                    ...
                    this.ippData = records.map((record) => {
                        ...
                        return {
                            ...
                            ippBalanceClass: ippBalance != null && isNegative(ippBalance) ? 'currency-negative' : '',
                            currentBalance: currentBalance,
                            currentBalanceFormatted: currentBalance != null ? formatCurrency(currentBalance, 0) : '-',
                            currentBalanceClass: currentBalance != null && isNegative(currentBalance) ? 'currency-negative' : '',
