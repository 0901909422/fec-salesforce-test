...
const DECISION_OPTIONS_MAP = {
  ...
  UpdateCC: [
    { label: "Pending CS", value: "Pending-CSInternal" },
    { label: "Pending Customer", value: "Pending-Customer" },
    { label: "Pending Card Ops", value: "Pending-CardOpsOutOfSystem" },
    { label: "Pending Collections", value: "Pending-CollectionsOutOfSystem" },
    {
      label: "Pending Contract Processing",
      value: "Pending-CPOutOfSystem",
    },
    { label: "Pending Credit Assessment", value: "Pending-CAOutOfSystem" },
    { label: "Pending Direct Sales", value: "Pending-DirectSalesOutOfSystem" },
    { label: "Pending Telesales", value: "Pending-TelesalesOutOfSystem" },
    { label: "Pending IT", value: "Pending-ITOutOfSystem " },
    { label: "Pending Payment", value: "Pending-PaymentOutOfSystem" },
    { label: "Pending Product", value: "Pending-PBDOutOfSystem" },
    { label: "Pending RCP&A", value: "Pending-RCPAOutOfSystem" },
    { label: "Pending Security", value: "Pending-SecurityOutOfSystem" },
    { label: "Pending Vendor", value: "Pending-VendorOutOfSystem" },
    { label: "Out Of Process", value: "Pending-OutOfProcess" },
    { label: "CIC Related", value: "Pending-CICRelated" },
    { label: "Document Preparation", value: "Pending-DocumentPreparation" },
    { label: "Task Under Review", value: "Pending-TaskUnderReview" },
