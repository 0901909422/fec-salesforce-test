...
const INSURANCE_STATUS_ACTIVE = 'Còn hiệu lực';
const INSURANCE_STATUS_EXPIRED = 'Hết hiệu lực';
const INSURANCE_STATUS_CANCELLED = 'Đã hủy';
const INSURANCE_STATUS_NOT_ON_CONTRACT = 'Chưa lên HĐ bảo hiểm';
const SCREEN_CUSTOMER_SEARCH = 'Customer Search';
const SCREEN_INTERNAL_CASE = 'Internal Case';
const SCREEN_ACCOUNT_CONTRACT_SEARCH = 'Account/Contract Search';
const PRODUCT_TYPE_LOAN_CASE = 'Loan';
const HAS_NO_PERMISSION_TO_CREATE_INTERACTION = 'You don\'t have permission to create or handle Interaction on this channel';
export { 
  ...
  SCREEN_CUSTOMER_SEARCH,
  SCREEN_INTERNAL_CASE,
  SCREEN_ACCOUNT_CONTRACT_SEARCH,
