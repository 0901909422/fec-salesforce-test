...
const MSG_PHONE_FORMAT_0_OR_84 =
  "Phone number must start with 0 (10 digits) or 84 (11 digits)";
const MSG_INVALID_NATIONAL_ID_OR_PASSPORT =
  "Invalid National ID or Passport number";
const MSG_NATIONAL_ID_9_OR_12_CHARS =
  "National ID must be 9 characters or 12 characters";
const MSG_PASSPORT_1_LETTER_7_DIGITS =
  "Passport must be 1 uppercase letter and 7 digits";
const MSG_PASSPORT_START_UPPERCASE_THEN_7 =
  "Passport must start with 1 uppercase letter (A-Z) then 7 digits";
const MSG_PASSPORT_1_UPPERCASE_FOLLOWED_BY_7 =
  "Passport must be 1 uppercase letter (A-Z) followed by 7 digits";
const MSG_PASSPORT_1_LETTER_7_DIGITS_ONLY =
  "Passport must be 1 uppercase letter and 7 digits only";
const MSG_NATIONAL_ID_9_OR_12_DIGITS =
  "National ID must be 9 digits or 12 digits";
const MSG_NATIONAL_ID_9_OR_12_DIGITS_ONLY =
  "National ID must be 9 or 12 digits only";
const MSG_NATIONAL_ID_PASSPORT_RULES =
  "National ID/Passport: digits only, or 1 uppercase letter + 7 digits for Passport";
const MSG_INVALID_NATIONAL_ID = "Invalid National ID number";
const MSG_NATIONAL_ID_DIGITS_ONLY_9_OR_12 =
  "National ID must contain digits only (9 or 12 digits)";
const MSG_INVALID_EMAIL_FORMAT =
...
const RESPONE_MESSARE_ERROR =
  "Số hợp đồng/ tài khoản này đã chuyển ngưng tác động thất bại";
const RESPONE_MESSARE_SUCCESS =
  "Số hợp đồng/ tài khoản này đã chuyển ngưng tác động thành công";
...
const PATTERN_EMAIL_FEC_STRICT =
...
const MSG_ENTER_EMAIL_CORRECTLY =
  "Please enter the email correctly before sending.";
...
const FEC_ERROR_LOADING_ORIGINAL_INFORMATION =
  "Error loading Original Information";
