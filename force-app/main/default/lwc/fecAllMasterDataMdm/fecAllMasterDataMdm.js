...
import { FIELD_ID, FIELD_EXTERNAL_ID, FIELD_NAME, FIELD_ALIAS, FIELD_CODE, FIELD_NAME_VN, FIELD_POS_ORDER, FIELD_STATUS, FIELD_PROCESS_STATUS, FIELD_ADDITIONAL_FIELD, FIELD_CHANNEL, FIELD_APPLICABLE_ROLE, FIELD_STAGE_NAME, FIELD_DATA_INTEGRATION_MAPPING, FIELD_FEC_TYPE, FIELD_ORDER_GENERIC, FIELD_FEC_PRODUCT_TYPE_NAME, FIELD_FEC_BUSINESS_PROCESS_NAME, FIELD_FEC_CATEGORY_NAME, FIELD_FEC_SUB_CATEGORY_NAME, FIELD_PROCESS_STATUS_NAME, FIELD_FEC_SUB_CODE, FIELD_FEC_CUSTOMER_TYPE } from 'c/fecConstants';
...
import { FIELD_CUSTOMER_TYPE, FIELD_CUSTOMER_TYPE_FLAT, FIELD_BUSINESS_PROCESS_NAME } from 'c/fecConstants';
